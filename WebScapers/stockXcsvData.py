...
#Read the file and get the sneaker name
    def scrape_shoes(self):
        sneaks = pandas.read_csv("/Users/seanbrown/Documents/StockX-Data-Contest-2019-3.csv",usecols=["Sneaker Name"])
        print(sneaks["Sneaker Name"])
        for i in sneaks["Sneaker Name"]:
            self.download_google_staticimages(i)
...
def main():
    men = WATScrper("https://www.dsw.com/en/us/brands/vans/N-1z14145?No={}","product-tile__product-image")
    men.scrape_shoes()
