...
def main():
    count = 0
    while count <= 192:
        rebok_women = WATScrper("https://www.reebok.com/us/women-shoes?start={}".format(count),"plp-grid___hCUwO")
        rebok_women.scrape_shoes()
        # rebok = WATScrper("https://www.reebok.com/us/men-shoes?start={}".format(count),"plp-grid___hCUwO")
        # rebok.scrape_shoes()
        count += 48
