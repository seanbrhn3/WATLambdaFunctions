...
class WATScrper():
    ...
    def scrape_shoes(self):
        ...
        sneakerhead_image = sneakerhead_object.find_all("span", {"class":"ProductName-primary"})
...
def main():
    count = 0
    while count < 28:
        men = WATScrper("https://www.footlocker.com/category/mens/shoes.html?currentPage={}".format(count),"ProductName-separator")
        men.scrape_shoes()
        count += 1
