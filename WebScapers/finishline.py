...
class WATScrper():
    ...
    def scrape_shoes(self):
        ...
        sneakerhead_image = sneakerhead_object.find_all("h2")
...
def main():
    count = 0
    while count < 40:
        men = WATScrper("https://www.finishline.com/store/women/shoes/_/N-1hednxh#/store/women/shoes/_/N-1hednxh?mnid=women_shoes&No={}".format(count),"row product-grid")
        men.scrape_shoes()
        count += 40
